...
# Bind Mount
mkdir -p /var/lib/docker/volumes/yottadb-data/_data
if ! mountpoint -q /var/lib/docker/volumes/yottadb-data/_data; then
    mount --bind /data /var/lib/docker/volumes/yottadb-data/_data
    echo "/data /var/lib/docker/volumes/yottadb-data/_data none bind 0 0" >> /etc/fstab
fi
